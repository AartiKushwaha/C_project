...
int main()
{
    ...
    struct points point[5] = { {1, "Patna_Pirates", 22, 20, 1, 1, 103}, {2, "Dabang_Delhi", 22, 19, 2, 1, 98},
    {3, "Bengaluru_Bulls", 22, 18, 4, 0, 90}, {4, "Mumbai_Indians", 22, 17, 4, 1, 88}, {5, "Telugu_Titans", 22, 16, 4, 2, 86}};

    struct best_players best[5] = { {1, "Pardeep_Narnal", "Patna_Pirates", "Raider  ", 350}, 
    {2, "Naveen_Kumar", "Dabang_Delhi", "Raider  ", 290}, {3, "Pawan_Sehrawat", "Bengaluru_Bulls", "Raider  ", 269},
    {4, "Fazal_Attrachli", "Mumbai_Indians", "Defender", 269}, {5, "Vishal_Bhardwaj", "Telugu_Titans", "Defender", 180}}; 
...
{
    int n;
    printf("\n\tEnter the serial number of the team: ");      //getting the serial number for the team to be added 
    scanf("%d",&n);
    printf("\tEnter number of matches played: ");
...
{
    int n;
    printf("\n\tEnter the serial number of the team: ");         //input of serial number to update the desired record
    scanf("%d",&n);
    printf("\tEnter name of the player: ");
